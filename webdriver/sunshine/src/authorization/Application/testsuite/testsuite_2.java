 ...
 * 注意事项：
 * 作者：曾昱皓
 * 日期：May 6, 2014 5:16:41 PM
*/
public class testsuite_2
{
    public testsuite_2(WebDriver driver)
    {
    ...
    public testsuite_2() throws FileNotFoundException, IOException
    {
        ...
        for (int i = 1; i <= count; i++)
        {
            ...
            sleep.wait(time);
            System.out.println("testsuite_2 is starting...");
            ...
            ScreenShot.takeScreenShot("testsuite_2_1", odriver); 
            sleep.wait(time);
            odriver.quit();
        }
    }
