 ...
 * 注意事项：
 * 作者：曾昱皓
 * 日期：May 6, 2014 5:17:41 PM
*/
public class testsuite_4
{
    public testsuite_4(WebDriver driver)
    {
    ...
    public testsuite_4() throws FileNotFoundException, IOException
    {
        ...
        for (int i = 1; i <= count; i++)
        {
            ...
            sleep.wait(time);
            System.out.println("testsuite_4 is starting...");
            ...
            ScreenShot.takeScreenShot("testsuite_4_1", odriver); 
            sleep.wait(time);
            odriver.quit();
        }
    }
