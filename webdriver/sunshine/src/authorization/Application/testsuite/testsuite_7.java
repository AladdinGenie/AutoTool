 ...
 * 注意事项：
 * 作者：曾昱皓
 * 日期：May 6, 2014 5:18:13 PM
*/
public class testsuite_7
{
    public testsuite_7(WebDriver driver)
    {
    ...
    public testsuite_7() throws FileNotFoundException, IOException
    {
        ...
        for (int i = 1; i <= count; i++)
        {
            ...
            sleep.wait(time);
            System.out.println("testsuite_7 is starting...");
            ...
            ScreenShot.takeScreenShot("testsuite_7_1", odriver); 
            sleep.wait(time);
            odriver.quit();
        }
    }
