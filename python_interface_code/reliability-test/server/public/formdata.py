...
def encode_multipart_formdata(fields):
    ...
    import random
    import os
    BOUNDARY = '----WebKitFormBoundary%s' % ''.join(random.sample('0123456789abcdef', 16))
    CRLF = '\r\n'
    L = []
...
if __name__ == "__main__":
    idcard = '350853198510059251'
    officeid = 27
    form_data = [('type', 'wechat'), ("idcard", idcard), ('officeid', str(officeid))]
    type, formed_data = encode_multipart_formdata(form_data)
    print type
    print formed_data
